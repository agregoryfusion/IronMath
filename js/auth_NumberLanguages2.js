// auth_NumberLanguages2.js - entry point for Germanic Number Languages game
import "./utils.js";
import "./backend_main.js";
import "./data_numberLanguages.js";
import "./backend_NumberLanguages2.js";
import "./gam_numberLanguages2.js";

const FM = (window.FastMath = window.FastMath || {});
const U = FM.utils;
const backendMain = FM.backendMain || {};
const backend = FM.backendNumberLanguages2 || {};
...
function showEmperor() {
  ...
  if (target) {
    ...
    emperorScore.textContent = `${target.numbersCorrect} Numbers Correct`;
  } else {
...
if (playBtn) {
  playBtn.addEventListener("click", () => {
    ...
    if (FM.numberLanguagesGame2 && typeof FM.numberLanguagesGame2.startGame === "function") {
      FM.numberLanguagesGame2.startGame();
    }
  });
}
...
if (leaderboardBtn) {
  leaderboardBtn.addEventListener("click", () => {
    if (loadingScreen) loadingScreen.style.display = "none";
    if (emperorScreen) emperorScreen.style.display = "none";
    if (FM.numberLanguagesGame2 && typeof FM.numberLanguagesGame2.showLeaderboardOnly === "function") {
      FM.numberLanguagesGame2.showLeaderboardOnly();
    }
  });
}
