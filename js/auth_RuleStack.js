// auth_RuleStack.js - entry point for Rule Stack game
import "./utils.js";
import "./backend_main.js";
import "./backend_RuleStack.js";
import "./RuleStack.js";
import "./ui_RuleStack.js";
...
if (playBtn) {
  playBtn.addEventListener("click", () => {
    if (emperorScreen) emperorScreen.style.display = "none";
    if (FM.ruleStackGame) FM.ruleStackGame.startGame();
  });
}
...
if (leaderboardBtn) {
  leaderboardBtn.addEventListener("click", () => {
    if (loadingScreen) loadingScreen.style.display = "none";
    if (emperorScreen) emperorScreen.style.display = "none";
    if (FM.ruleStackGame && typeof FM.ruleStackGame.showLeaderboardOnly === "function") {
      FM.ruleStackGame.showLeaderboardOnly();
    }
  });
}
