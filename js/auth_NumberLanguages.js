// auth_NumberLanguages.js - entry point for Number Languages game
import "./utils.js";
import "./backend_main.js";
import "./data_numberLanguages.js";
import "./backend_NumberLanguages.js";
import "./gam_numberLanguages.js";
...
if (playBtn) {
  playBtn.addEventListener("click", () => {
    ...
    if (FM.numberLanguagesGame && typeof FM.numberLanguagesGame.startGame === "function") {
      FM.numberLanguagesGame.startGame();
    }
  });
}
...
if (leaderboardBtn) {
  leaderboardBtn.addEventListener("click", () => {
    if (loadingScreen) loadingScreen.style.display = "none";
    if (emperorScreen) emperorScreen.style.display = "none";
    if (FM.numberLanguagesGame && typeof FM.numberLanguagesGame.showLeaderboardOnly === "function") {
      FM.numberLanguagesGame.showLeaderboardOnly();
    }
  });
}
