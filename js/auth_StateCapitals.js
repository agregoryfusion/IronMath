// auth_StateCapitals.js - entry point for State Capitals game
import "./utils.js";
import "./backend_main.js";
import "./backend_StateCapitals.js";
import "./gam_stateCapitals.js";
...
function showEmperor() {
  ...
  if (target) {
    ...
    emperorScore.textContent = `${target.statesCorrect} States Correct`;
  } else {
...
if (playBtn) {
  playBtn.addEventListener("click", () => {
    ...
    if (FM.stateCapitalsGame && typeof FM.stateCapitalsGame.startGame === "function") {
      FM.stateCapitalsGame.startGame();
    }
  });
}
...
if (leaderboardBtn) {
  leaderboardBtn.addEventListener("click", () => {
    if (loadingScreen) loadingScreen.style.display = "none";
    if (emperorScreen) emperorScreen.style.display = "none";
    if (FM.stateCapitalsGame && typeof FM.stateCapitalsGame.showLeaderboardOnly === "function") {
      FM.stateCapitalsGame.showLeaderboardOnly();
    }
  });
}
