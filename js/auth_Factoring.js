// auth_Factoring.js - entry point for Factor Sprint
import "./utils.js";
import "./backend_main.js";
import "./backend_Factoring.js";
import "./FactoringGame.js";
import "./ui.js";
...
if (playBtn) {
  playBtn.addEventListener("click", () => {
    if (emperorScreen) emperorScreen.style.display = "none";
    if (FM.factorGame) FM.factorGame.startGame();
  });
}
...
if (leaderboardBtn) {
  leaderboardBtn.addEventListener("click", () => {
    if (loadingScreen) loadingScreen.style.display = "none";
    if (emperorScreen) emperorScreen.style.display = "none";
    if (FM.factorGame && typeof FM.factorGame.showLeaderboardOnly === "function") {
      FM.factorGame.showLeaderboardOnly();
    }
  });
}
